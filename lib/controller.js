define([
  ...
  function Controller(couch_url, template_dir, cb){
    ...
    _init(self.endpoint, function(err, schemas){
      ...
      if (!template_dir) return cb(null, self);
    ...
    couchr.get(self.endpoint.view(id), function(err, doc){
        ...
        var type = doc.type,
            ...
            data = {
              doc: doc,
              qs: function(data){
                return encodeURIComponent(URI.buildQuery(data))
              }
            },
            ractive;
